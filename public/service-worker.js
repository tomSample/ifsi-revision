 ...
 * Version 2.0 - Structure de projet optimisée
 */
...
const CRITICAL_ASSETS = [
    ...
    '/src/frontend/pages/statistics.html',
    '/src/frontend/pages/account.html',
    '/src/frontend/pages/admin.html',
    '/src/frontend/assets/styles/style.css',
    '/src/frontend/assets/styles/style-revision.css',
    '/src/frontend/assets/scripts/auth/auth.js',
    '/src/frontend/assets/scripts/auth/auth-guard.js',
    '/src/frontend/assets/scripts/modules/sync-manager.js',
    '/src/frontend/assets/scripts/modules/spaced-repetition.js',
    '/src/frontend/assets/scripts/modules/revision.js',
    '/src/frontend/assets/scripts/modules/statistics.js',
    '/src/frontend/assets/scripts/modules/account.js',
    '/src/frontend/assets/scripts/modules/admin.js',
